...
QUESTIONS = [
    ...
    },
    {
        ...
        "correct": 0,
        "explanation": "According to NJ law, you must stop at least 25 feet away from a school bus displaying flashing red lights to ensure student safety."
    },
...
for i in range(40, 151):
    ...
    if category == "Traffic Laws & Rules of the Road":
        ...
        question_templates = [
            ...
            "A green arrow pointing left means:",
            "When the traffic light is not working, treat the intersection as:"
        ]
        options_templates = [
            ["Stop", "Proceed with caution", "Speed up", "Turn right only"],
            ["Turn right after stopping", "Proceed straight", "Turn left", "Make a U-turn"],
            ["Turn left after yielding", "Turn left immediately", "No left turn", "Stop and wait"],
        ...
        question_templates = [
            "Before backing up your vehicle, you should:",
            "When driving in fog, you should:",
            "The safest way to exit an expressway is to:",
            "When approaching a curve, you should:"
        ]
        options_templates = [
            ["Sound the horn", "Check mirrors and look behind", "Shift to reverse quickly", "Turn on hazards"],
            ...
            ["Accelerate through it", "Brake in the curve", "Slow down before entering", "Sound the horn"]
        ]
    ...
    if category == "Traffic Laws & Rules of the Road":
        correct_answers = [0, 1, 0, 2]  # 25 mph, 100 feet, 0.01%, 5am-11pm
        explanations = [
            ...
            "New Jersey's zero tolerance law means drivers under 21 are considered DUI at 0.01% BAC or higher.",
            "With a special learner's permit, you can practice drive between 5 a.m. and 11 p.m. with supervision."
        ]
    elif category == "Road Signs & Traffic Signals":
        correct_answers = [1, 0, 0, 0]  # Prohibited, Services, School zone, Steep hill
        explanations = [
            "A red circle with a line through it indicates a prohibited action.",
        ...
        correct_answers = [1, 0, 1, 0]  # Caution, Right turn after stop, Turn left immediately, Four-way stop
        explanations = [
            "A flashing yellow light means proceed with caution after yielding to any traffic or pedestrians.",
            "At a red light, you may turn right after coming to a complete stop and yielding to traffic and pedestrians.",
            "A green arrow means you may turn in the direction of the arrow immediately.",
            "When traffic lights are not working, treat the intersection as a four-way stop."
        ]
    elif category == "Alcohol & Drug Awareness":
        ...
        correct_answers = [1, 1, 0, 2]  # Check mirrors and look behind, Use low beams, Slow down before exit, Slow down before entering
        explanations = [
            "Always check mirrors and physically look behind you before backing up.",
            ...
            "Slow down before entering curves to maintain control of your vehicle."
        ]
    elif category == "Pedestrian & Special Situations":
...
if not st.session_state.test_started:
    ...
    if current_question_data is None:
        # End of current category, move to next or show completion
